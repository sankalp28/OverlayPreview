...
export default {
  ...
  methods: {
    ...
    setBoxSize(){
      this.widgetBoundArea = document.getElementById("").getBoundingClientRect();
      this.previewBoxSize.width = this.widgetBoundArea.width;
      this.previewBoxSize.height = this.widgetBoundArea.height;
