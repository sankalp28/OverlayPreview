<template>
  <div class="text-editor">
    ...
    <div class="overlay-row">
        ...
        <div class="typography">
            <div class="slider-sec"><input type="range" name="crawlSpeed" min="1" max="100" :value="widgetData.properties.crawlSpeed" v-on:input="handleChangeColor" class="slider" id="myRange"></div>
            <span class="padding-value"> <input type="text" name="" :value="widgetData.properties.crawlSpeed"><small>x</small></span>
        </div>
    </div>
